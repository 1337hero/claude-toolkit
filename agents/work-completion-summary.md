...
USER_NAME: "Mike"
PIPER_VOICE: ~/.local/share/piper-voices/jarvis/en/en_GB/jarvis/medium/jarvis-medium.onnx
...
4. **Generate and play audio**:
   - Use piper for local TTS: `echo "your summary text" | piper -m ~/.local/share/piper-voices/jarvis/en/en_GB/jarvis/medium/jarvis-medium.onnx`
   - This plays audio directly via ffplay
...
- IMPORTANT: Run only bash with piper. Do not use any other tools. Base your summary on the user prompt given to you.

## Report / Response

Your response should include:
- The text of your audio summary
- Confirmation that audio was played
